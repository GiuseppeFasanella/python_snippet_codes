...
##pass a 'datetime' (see how string--> datetime)
parser.add_argument("--train_st", default='2015-01-01 00',help="pass it as '20150201 00'")
#call it as
...
args.train_st = datetime.strptime(args.train_st, '%Y-%m-%d %H')
